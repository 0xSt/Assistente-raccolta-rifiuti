...
5. **Procedure di smaltimento complesse.** 195 voci di Napoli su 578 finiscono in un'isola ecologica, 57 chiedono una prenotazione telefonica, 115 hanno destinazioni su più canali. Per queste la risposta "va in X" è vera e insufficiente: manca il *come*. I dati per dirlo ci sono già nel canale della destinazione; servono un testo di procedura per canale e una presentazione a passi. Vedi le note sotto.
